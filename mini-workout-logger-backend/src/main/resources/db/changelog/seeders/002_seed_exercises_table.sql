...
BEGIN
    ...
    -- Get the exercise ID
    SELECT id INTO p_exercise_id FROM exercises WHERE name = exercise_name;
...
SELECT add_exercise(
    'Exercise.Reverse_Fly',
    'STRENGTH',
    'NOVICE',
    ARRAY['DUMBBELL','CABLE','EXERCISE_BALL']
);
...
SELECT add_exercise(
    ...
    'STRENGTH',
    'BEGINNER',
    ARRAY['BODYWEIGHT','EXERCISE_BALL','TRX']
);
...
SELECT add_exercise(
    ...
    'STRENGTH',
    'BEGINNER',
    ARRAY['MEDICINE_BALL','BODYWEIGHT']
);
